...
type Spider interface {
	Init()
	GetUrls(parameters string) map[string]map[string]string
	ParseUrl(params map[string]string) string
	GetStockdata(code string, content string) map[string]map[string]string
	Run(parameters string) map[string]map[string]string
}
type IndexDataSpider struct {
	GsApi      string
...
func (this *IndexDataSpider) Init() {
	...
	this.codes = []string{"399001", "000001", "399006"}
}

func (this *IndexDataSpider) GetUrls(parameters string) map[string]map[string]string {
...
func (this *IndexDataSpider) ParseUrl(params map[string]string) string {
...
func (this *IndexDataSpider) GetStockdata(code string, content string) map[string]map[string]string {
...
func (this *IndexDataSpider) Run(parameters string) map[string]map[string]string {
	this.Init()
	data := make(map[string]map[string]string)
	gpurl_dict := this.GetUrls(parameters)
